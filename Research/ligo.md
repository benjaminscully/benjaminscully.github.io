...
By then feeding the classifier glitches that were not defined in GSpyNetTree, we were able to directly identify shortcomings. My work showed that the four top-offenders of new glitches being put into the 'no glitch' cluster had very high frequecy morphology. With this, we could conclude that the classifier was in need of a new 'high-frequency glitch' category to effectively distinguish between different signals.
<center>
